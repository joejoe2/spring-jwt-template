...
class ActivationServiceTest {
  ...
  void activateUserWithIllegalArgument() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> activationService.activateUser("invalid uid"));
  }
  ...
  void activateUserWithInvalidOperation() {
    ...
    assertThrows(
        InvalidOperation.class, () -> activationService.activateUser(user.getId().toString()));
  ...
  void deactivateUserWithInvalidOperation() {
    ...
    userRepository.save(user);
    assertThrows(
        InvalidOperation.class, () -> activationService.deactivateUser(user.getId().toString()));
