...
public interface JwtService {
  ...
  /**
   * use refresh token(in plaintext) to exchange new access and refresh token, then the old refresh
   * token will be deleted and the related access token will also be revoked
   *
